...
Scenario: Update a Product
  ...
  And I press the "Search" button
  Then I should see the message "Success"
  When I set the "Description" to "A new red fedora"
  And I set the "Price" to "69.95"
  And I select "False" in the "Available" dropdown
  And I select "Accessories" in the "Category" dropdown
  ...
  And I should see "Accessories" in the "Category" dropdown
...
Scenario: Delete a Product
  ...
  And I press the "Search" button
  Then I should see the message "No product found"

Scenario: List all Products
  When I visit the "Home Page"
  Then I should see a list of products
  And I should see at least one product in the list
  And I should see "Hat" in the product names
...
Scenario: Search for Products by Category
  ...
  Then I should see the message "Success"
  And I should see "Hat" in the product names
  And I should see "Shoes" in the product names
...
Scenario: Search for Products by Availability
  ...
  Then I should see the message "Success"
  And I should see "Hat" in the product names
  And I should see "Big Mac" in the product names
  And I should see "Sheets" in the product names
...
Scenario: Search for Products by Name
  ...
  Then I should see the message "Success"
  And I should see "Hat" in the product names
  And I should not see "Shoes" in the product names
